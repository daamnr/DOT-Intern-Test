...
function Question() {
  ...
  return (
    <AnimateProvider className="max-w-xl mx-auto ">
      <h1 className="text-base md:text-lg font-semibold mb-5 text-[#1E2739]">
        Quizzz Info
      </h1>
      ...
      <button
        ...
        className="flex w-full rounded-full bg-primary cursor-pointer disabled:bg-primary/50 disabled:cursor-not-allowed p-1 justify-center font-semibold md:font-bold text-base md:text-md text-center mt-10 text-white hover:bg-primary"
      >
        Start Quiz
      </button>
    </AnimateProvider>
